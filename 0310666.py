...
columns_to_copy = ['OUTCOME','preparation_time','Nutritional_Methods','blood_glucose_0_7.8-11.1','blood_glucose_1_11.1','blood_glucose_2_7.8','mechanical_ventilation']  
...
joblib.dump(rfc, 'rfc0310.pkl')

# Load the model
model = joblib.load('rfc0310.pkl')         
...
feature_names = ['P_F', 'LAC','preparation_time', 'Nutritional_Methods', 'blood_glucose_0_7.8-11.1',
...
blood_glucose_2= st.selectbox("blood_glucose_2_7.8(0=NO, 1=YES):", options=[0, 1], format_func=lambda x: 'NO (0)' if x == 0 else 'YES (1)')
...
feature_values = [P_F,LAC,preparation_time,Nutritional_Methods,blood_glucose_0,blood_glucose_1,blood_glucose_2,mechanical_ventilation]
